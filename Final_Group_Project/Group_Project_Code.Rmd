...
ggraph(network_graph, layout="fr") +geom_edge_link(arrow = arrow(length = unit(1,'mm')),end_cap = circle(1.2,'mm'))+geom_node_point(aes(size=Degree, color=nodes$wg), show.legend=T)
```
